...
const characterData7 = {
	poseNumber: 0,
	elem: document.querySelector(".animate"),
	screenWidth: document.querySelector("#castle").clientWidth,
	screenHeight: document.querySelector("#castle").scrollHeight,
	x: 0,
	y: document.querySelector("#castle").scrollHeight - 1000,
	timerId: null
};
//function move() {
...
characterData7.timerId = setInterval(frame7, 100);
//}
function frame() {
...
function frame7() {
	if (characterData7.x > characterData7.screenWidth - 150) {
		characterData7.x = 5;
	} else {
		characterData7.x += 2;
		characterData7.elem.style.top = characterData7.y + "px";
		characterData7.elem.style.left = characterData7.x + "px";
		//characterData7.elem.src =
			//"santaFly\\" + characterData7.arrImgs[characterData7.poseNumber];
		//console.log(characterData7.elem.src);
		characterData7.poseNumber = (characterData7.poseNumber + 1) % 4;
	}
}
/*function frame() {
    if (pos == 350) {
